...
const YearModal = ({ open, onClose, subject, topics, onSubmit }) => {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <h3 className="modal-title">{subject} - Select Year</h3>
        <p className="modal-subtitle">Choose one or more year for your practice test.</p>
